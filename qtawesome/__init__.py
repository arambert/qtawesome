...
_BUNDLED_FONTS = (
    ...
    ('fa6',
        'fontawesome5-regular-webfont-6.6.0.ttf',
        'fontawesome5-regular-webfont-charmap-6.6.0.json'),
    ('fa6s',
        'fontawesome5-solid-webfont-6.6.0.ttf',
        'fontawesome5-solid-webfont-charmap-6.6.0.json'),
    ('fa6l',
        'fontawesome5-light-webfont-6.6.0.ttf',
        'fontawesome5-light-webfont-charmap-6.6.0.json'),
    ('fa6d',
        'fontawesome5-duotone-webfont-6.6.0.ttf',
        'fontawesome5-duotone-webfont-charmap-6.6.0.json'),
    ('fa6t',
        'fontawesome5-thin-webfont-6.6.0.ttf',
        'fontawesome5-thin-webfont-charmap-6.6.0.json'),
    ('fa6b',
        'fontawesome5-brands-webfont-6.6.0.ttf',
        'fontawesome5-brands-webfont-charmap-6.6.0.json'),
    ('ei',
